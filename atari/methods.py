...
class GaussianDeepQNetwork:
    ...
    def __init__(self, num_actions, state_shape=[8, 8, 5],
        ...
        with tf.variable_scope(scope, reuse=reuse):
            ...
            self.sigma = base_sigma + sigma_nonlinearity(sigma)
            ...
            denom = 2*tf.square(sigma_selected)
...
class ReplayMemory:
    ...
    def get_batch(self, batch_size):
        """ sample mini batch of transitions from replay memory
        """
